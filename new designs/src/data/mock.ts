...
export const SCHEDULE_TEMPLATES: ScheduleTemplate[] = [
  ...
  {
    id: 3,
    name: 'Summer Intensive (12-hour day)',
    description: 'Summer immersion: a full 12-hour structured day, every day. Two deep-work blocks around the three talks, plus an evening build block.',
    source: 'org',
    schedule: DEFAULT_SCHEDULE,
    blocks: [
      { id: 301, label: 'Journaling', time: '6:30 AM', days: 'everyday' },
      { id: 302, label: 'Morning reading', time: '7:00 AM', days: 'everyday' },
      { id: 303, label: 'Breakfast + Mindset talk', time: '8:00 AM', days: 'everyday' },
      { id: 304, label: 'Deep work I', time: '9:00 AM', days: 'everyday', bookable: true },
      { id: 305, label: 'Lunch + Engineering talk', time: '1:00 PM', days: 'everyday' },
      { id: 306, label: 'Deep work II', time: '2:00 PM', days: 'everyday' },
      { id: 307, label: 'Dinner + Dean talk', time: '7:00 PM', days: 'everyday' },
      { id: 308, label: 'Evening build block', time: '8:00 PM', days: 'everyday' },
    ],
  },
  {
    id: 4,
    name: 'Student schedule',
    description: 'For mentees in school: the structured day fits around classes on weekdays, with a lighter study block and the weekend grind plus family time.',
    source: 'org',
    schedule: DEFAULT_SCHEDULE,
    blocks: [
      { id: 401, label: 'Journaling', time: '7:00 AM', days: 'weekdays' },
      { id: 402, label: 'Morning reading', time: '7:30 AM', days: 'weekdays' },
      { id: 403, label: 'Breakfast + Mindset talk', time: '8:30 AM', days: 'weekdays' },
      { id: 404, label: 'Classes', time: '10:00 AM', days: 'weekdays' },
      { id: 405, label: 'Lunch + Engineering talk', time: '1:00 PM', days: 'weekdays' },
      { id: 406, label: 'Study + core work', time: '4:00 PM', days: 'weekdays', bookable: true },
      { id: 407, label: 'Dinner + Dean talk', time: '7:00 PM', days: 'weekdays' },
      { id: 408, label: 'Weekend grind', time: '10:00 AM', days: 'weekends' },
      { id: 409, label: 'Family time', time: 'Evening', days: 'weekends' },
    ],
  },
  {
    id: 5,
    name: 'Interview schedule',
    description: 'Interview season: DSA practice in the morning, system design and mock interviews in the afternoon, and a weekend mock-interview marathon.',
    source: 'org',
    schedule: DEFAULT_SCHEDULE,
    blocks: [
      { id: 501, label: 'Journaling', time: '7:00 AM', days: 'weekdays' },
      { id: 502, label: 'Morning reading', time: '7:30 AM', days: 'weekdays' },
      { id: 503, label: 'Breakfast + Mindset talk', time: '8:30 AM', days: 'weekdays' },
      { id: 504, label: 'DSA practice', time: '9:30 AM', days: 'weekdays', bookable: true },
      { id: 505, label: 'Lunch + Engineering talk', time: '1:00 PM', days: 'weekdays' },
      { id: 506, label: 'System design + mock interview', time: '3:00 PM', days: 'weekdays' },
      { id: 507, label: 'Dinner + Dean talk', time: '7:00 PM', days: 'weekdays' },
      { id: 508, label: 'Mock interview marathon', time: '10:00 AM', days: 'weekends' },
      { id: 509, label: 'Family time', time: 'Evening', days: 'weekends' },
    ],
  },
  {
    id: 6,
    name: 'Job hunt schedule',
    description: 'Active job hunt: a daily applications block, networking and outreach, and interview prep, with a weekend portfolio grind.',
    source: 'org',
    schedule: DEFAULT_SCHEDULE,
    blocks: [
      { id: 601, label: 'Journaling', time: '7:00 AM', days: 'weekdays' },
      { id: 602, label: 'Morning reading', time: '7:30 AM', days: 'weekdays' },
      { id: 603, label: 'Breakfast + Mindset talk', time: '8:30 AM', days: 'weekdays' },
      { id: 604, label: 'Applications block', time: '9:30 AM', days: 'weekdays' },
      { id: 605, label: 'Lunch + Engineering talk', time: '1:00 PM', days: 'weekdays' },
      { id: 606, label: 'Networking + outreach', time: '2:30 PM', days: 'weekdays' },
      { id: 607, label: 'Interview prep', time: '4:00 PM', days: 'weekdays', bookable: true },
      { id: 608, label: 'Dinner + Dean talk', time: '7:00 PM', days: 'weekdays' },
      { id: 609, label: 'Weekend portfolio grind', time: '10:00 AM', days: 'weekends' },
      { id: 610, label: 'Family time', time: 'Evening', days: 'weekends' },
    ],
  },
  {
    id: 7,
    name: 'Open source schedule',
    description: 'For mentees contributing to open source: a daily contribution block, issue triage and code review, and a weekend feature grind.',
    source: 'org',
    schedule: DEFAULT_SCHEDULE,
    blocks: [
      { id: 701, label: 'Journaling', time: '7:00 AM', days: 'weekdays' },
      { id: 702, label: 'Morning reading', time: '7:30 AM', days: 'weekdays' },
      { id: 703, label: 'Breakfast + Mindset talk', time: '8:30 AM', days: 'weekdays' },
      { id: 704, label: 'OSS contribution block', time: '9:30 AM', days: 'weekdays', bookable: true },
      { id: 705, label: 'Lunch + Engineering talk', time: '1:00 PM', days: 'weekdays' },
      { id: 706, label: 'Issue triage + code review', time: '3:00 PM', days: 'weekdays' },
      { id: 707, label: 'Dinner + Dean talk', time: '7:00 PM', days: 'weekdays' },
      { id: 708, label: 'Weekend feature grind', time: '10:00 AM', days: 'weekends' },
      { id: 709, label: 'Family time', time: 'Evening', days: 'weekends' },
    ],
  },
];
