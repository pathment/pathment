  ...
  const getTaskAssignmentButton = (task: any, weekNumber: number) => {
    ...
    if (!selectedMenteeForAssign)
      return (
        <button
          disabled
          className="px-4 py-2 bg-slate-200 text-slate-400 cursor-not-allowed rounded-lg text-sm font-medium"
        >
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-600">
          Review submissions and manage tasks for your mentees
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <StatsCard
          ...
          value={statsLoading ? "—" : stats?.reviewedToday || 0}
            ...
            [
              {
                ...
                icon: Clock,
                count:
                  pendingTasks.length > 0 ? pendingTasks.length : undefined,
              },
              {
                id: "extensions",
                label: "Extensions",
                  ...
                  {pendingTasks.map((task) => (
                    ...
                    >
                        ...
                        <div className="mb-4 p-4 bg-white rounded-lg">
                          <div
                            ...
                            dangerouslySetInnerHTML={{
                              __html: task.submissions[0].submissionText,
                            }}
                          />
                          {task.submissions[0].submissionUrls?.length > 0 && (
                            <div className="mt-2">
                              ...
                              {task.submissions[0].submissionUrls.map(
                      ...
                      <div className="flex gap-2">
                        <button
                          onClick={() =>
                            router.push(`/mentor/tasks/${task.id}/feedback`)
                          }
                          ...
                          <div className="flex items-start gap-3 mb-3">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-red-700 text-sm mb-3">
                                This will mark the task as cancelled. The mentee
                                will be notified.
                              </p>
                              <textarea
                                value={cancelReason}
            ...
            <div>
              {allTasksLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-500 text-sm">
                    Extension requests from your mentees will appear here.
                  </p>
                </div>
              ) : (
                <div className="space-y-4">
                  {extensionTasks.map((task) => {
                    const ext = task.submissions?.find(
                      (s: any) =>
                    ...
                    const currentDue = task.dueDate
                      ...
                      : null;
                    const newDue =
                      currentDue && ext?.extensionDays
                        ? new Date(
                            currentDue.getTime() + ext.extensionDays * 86400000
                          )
                        : null;
                    return (
                      <div
                        ...
                        <div className="grid sm:grid-cols-3 gap-4 mb-4 p-4 bg-white rounded-xl border border-orange-100">
                          <div>
                            ...
                            <p className="text-sm font-medium text-slate-900">
                              {ext?.extensionDays} day
                              {ext?.extensionDays !== 1 ? "s" : ""}
                            </p>
                          </div>
                          <div>
                            <p className="text-xs text-slate-500 mb-1">
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-slate-500 text-sm">
                        {searchTerm
                          ...
                          : "Tasks will appear here when mentees are assigned"}
                      </p>
                    </div>
                  ) : (
                    <div className="space-y-3">
                      {filteredAllTasks.map((task) => {
                        const pendingExtension = task.submissions?.find(
                          (s: any) =>
                            s.extensionRequested &&
                            s.extensionStatus === "pending"
                        );
                        return (
                          <div
                            key={task.id}
                            ...
                            <div className="flex items-start justify-between mb-2">
                              <div className="flex-1">
                                ...
                                <div className="flex items-center gap-3 text-sm text-slate-600 flex-wrap">
                                  <span>
                                    {task.mentee?.firstName}{" "}
                                    {task.mentee?.lastName}
                                  </span>
                                  <span>•</span>
                                  <span>
                                    {task.enrollment?.currentLevel?.name}
                                  </span>
                                  <span>•</span>
                                  <span>
                                    Due{" "}
                                ...
                                {pendingExtension && (
                                  <p className="text-xs text-orange-700 mt-1">
                                    Requesting{" "}
                                    <strong>
                                      {pendingExtension.extensionDays} day
                                      {pendingExtension.extensionDays !== 1
                                        ? "s"
                                        : ""}
                                    </strong>
                                    : &quot;{pendingExtension.extensionReason}
                                    &quot;
                                  </p>
                                )}
                              </div>
                              ...
                              <div className="mt-3 p-4 bg-red-50 border border-red-200 rounded-lg">
                                <div className="flex items-start gap-3">
                                  ...
                                  <div className="flex-1">
                                    ...
                                    <p className="text-red-700 text-sm mb-3">
                                      This will mark the task as cancelled. The
                                      mentee will be notified.
                                    </p>
                                    <textarea
                                      value={cancelReason}
                                      onChange={(e) =>
          ...
          {activeTab === "roadmap" && (
            <div>
              <h3 className="text-slate-900 mb-6">
                Program Roadmap & Task Assignment
              </h3>
                ...
                <>
                  ...
                  <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <div>
                      <label className="block text-slate-700 text-sm font-medium mb-2">
                        <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-indigo-100 text-indigo-700 text-xs font-bold mr-1.5">
                          1
                        </span>
                        Program
                      </label>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          handleMenteeForAssignChange(e.target.value)
                        }
                  ...
                  {!selectedProgram && (
                    <div className="text-center py-12 bg-slate-50 rounded-xl border border-slate-200">
                      ...
                      <p className="text-slate-500 text-sm">
                        Then pick a level and a mentee to view and assign
                        roadmap tasks
                      </p>
                    </div>
                  )}
                  ...
                  {selectedProgram && !selectedLevel && (
                    <div className="text-center py-12 bg-slate-50 rounded-xl border border-slate-200">
                      ...
                      <p className="text-slate-500 text-sm">
                        Choose the program level whose roadmap you want to view
                      </p>
                    </div>
                  )}
                  ...
                  {selectedProgram &&
                    ...
                    !selectedMenteeForAssign && (
                      <div className="text-center py-12 bg-slate-50 rounded-xl border border-slate-200">
                        <BookOpen className="w-12 h-12 text-slate-300 mx-auto mb-3" />
                        <p className="text-slate-600 mb-2">
                          Select a mentee to load the roadmap
                        </p>
                        <p className="text-slate-500 text-sm">
                          The roadmap will show each task's assignment status
                          for that mentee
                        </p>
                      </div>
                    )}
                    ...
                    <div className="space-y-6">
                      <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <h4 className="text-indigo-900 font-medium mb-1">
                              {roadmapData.title}
                            </h4>
                                  ...
                                  <div className="flex items-start justify-between mb-3">
                                    <div className="flex-1">
                                      <div className="flex items-center gap-2 mb-1">
                                        <h5 className="text-slate-900 font-medium">
                                          {task.title}
                                        </h5>
                                        <span
                  ...
                  <div>
                    ...
                    >
                      ...
                      {mentees.map((match) => (
                        <option
                          key={`${match.menteeId}-${
                            match.enrollment?.programId ??
                            match.enrollment?.program?.name
                          }`}
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        max={
                          programDateRange.endDate?.split("T")[0] || undefined
                        }
                        className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            pointsBase: parseInt(e.target.value) || 0,
                          })
                        }
                        placeholder="e.g., 100"
                        min="0"
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <ul className="text-blue-700 text-sm space-y-1">
                      ...
                      <li>
                        • Consider the mentee's current level and progress
                      </li>
                    </ul>
                  </div>
                </div>
