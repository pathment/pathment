...
export default function TaskSubmission() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setShowSuccess(true);
    setTimeout(() => navigate('/mentee/tasks'), 2000);
  };
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-6">
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm mt-2">
                  Provide details about your approach and any key decisions you made
                </p>
              </div>
              ...
              <div>
                    ...
                    <div key={index} className="flex gap-2">
                      <div className="relative flex-1">
                        ...
                        <input
                          ...
                          placeholder="https://github.com/yourrepo or https://demo-url.com"
                        />
                ...
                <p className="text-slate-500 text-sm mt-2">
                  Add links to your GitHub repository, deployed app, or documentation
                </p>
              </div>

              {/* File Upload */}
              <div>
                <label className="block text-slate-900 mb-2">Attach Files (Optional)</label>
                <div className="border-2 border-dashed border-slate-300 rounded-xl p-6 text-center hover:border-indigo-400 transition-colors">
                  ...
                  <label
                    htmlFor="file-upload"
                    className="inline-block px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg cursor-pointer transition-colors"
                  >
                    Choose Files
                  </label>
                  <p className="text-slate-500 text-sm mt-2">PDF, Images, or ZIP files (Max 10MB)</p>
                </div>
                    ...
                    {submission.files.map((file, index) => (
                      <div key={index} className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-slate-900 text-sm">{file.name}</span>
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-xl flex items-start gap-3">
                ...
                <div>
                  <p className="text-blue-900 text-sm">
                    Your mentor will review your submission and provide feedback within 24-48 hours.
                  </p>
                </div>
              </div>
            </div>
