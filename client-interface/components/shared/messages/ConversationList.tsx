      ...
      <div className="p-3 sm:p-4 border-b border-slate-200/80 space-y-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-1.5 bg-slate-50 border border-slate-200/80 rounded-xl text-xs text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all"
          />
        </div>
        ...
        <div className="flex items-center gap-1 p-0.5 bg-slate-100 rounded-xl">
          <button
            ...
            className={`flex-1 py-1 px-2.5 text-xs font-medium rounded-lg transition-all flex items-center justify-center gap-1 ${
              activeTab === 'all'
                ? 'bg-card text-slate-900 shadow-2xs'
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <button
                            ...
                            className="p-1 rounded-lg opacity-0 group-hover:opacity-100 focus:opacity-100 hover:bg-slate-200/60 transition-all text-slate-500"
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <p className={`text-xs truncate flex items-center gap-1 ${hasUnread ? 'font-medium text-slate-800' : 'text-slate-500'}`}>
