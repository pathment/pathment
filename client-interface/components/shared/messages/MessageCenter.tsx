              ...
              <div className="absolute bottom-20 right-6 z-20 w-[420px] bg-card/95 backdrop-blur-xl border border-brand-200 dark:border-brand-500/30 shadow-2xl rounded-2xl p-4 overflow-y-auto max-h-[50vh] transition-all animate-in slide-in-from-right-4">
                ...
                <div className="space-y-3">
                  ...
                  {conversationDrafts.map(draft => {
                    ...
                    const confidenceColor = draft.confidenceScore >= 0.8
                        ...
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className="flex gap-2 items-center">
                            ...
                            {draft.groundingScore !== undefined && (
                              <span className="text-[10px] px-2 py-0.5 rounded-full font-medium bg-indigo-100 text-indigo-700 dark:bg-indigo-950/40 dark:text-indigo-300">
                          ...
                          <div className="mt-1">
                            ...
                            <div className="flex justify-end gap-2 mt-2">
                              <button
                                ...
                                className="text-xs font-medium text-slate-500 dark:text-slate-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/40 px-2 py-1 rounded-md transition-colors"
                              >
                                Reject
                              </button>
                              <button
                                onClick={() => { setEditingDraftId(draft.id); setDraftEditorText(draft.draftContent); }}
                                className="text-xs font-medium text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 hover:bg-brand-50 dark:hover:bg-brand-500/15 px-2 py-1 rounded-md transition-colors"
                              >
                                Review & Edit
                              </button>
                            </div>
                  ...
                  {isGenerating && (
                    <div className="flex items-center gap-2.5 bg-brand-50 dark:bg-brand-500/10 border border-brand-200 dark:border-brand-500/25 rounded-xl px-3 py-2.5">
                      <Loader2 className="w-3.5 h-3.5 animate-spin text-brand-500 dark:text-brand-400 shrink-0" />
                      <span className="text-xs text-brand-700 dark:text-brand-300 font-medium">Generating new draft…</span>
                    </div>
                  )}
                </div>
              </div>
