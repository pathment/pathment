...
export default function FeedbackProvision() {
  const { id } = useParams();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setShowSuccess(true);
    setTimeout(() => navigate('/mentor/tasks/review'), 2000);
  };
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="lg:pl-64">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {/* Header */}
          <button
            onClick={() => navigate('/mentor/tasks/review')}
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <CheckCircle2 className={`w-6 h-6 flex-shrink-0 ${decision === 'approve' ? 'text-green-600' : 'text-slate-600'}`} />
                      <div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <RotateCw className={`w-6 h-6 flex-shrink-0 ${decision === 'revision' ? 'text-orange-600' : 'text-slate-600'}`} />
                      <div>
